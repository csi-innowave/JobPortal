  ...
  return (
    <div className="min-h-screen  p-8">
      <div className="max-w-4xl mx-auto">
       ...
       <h1 className="text-4xl font-bold text-gray-800 mb-8">Find Your Dream Job at <span className='text-purple-600'>CSI-INNOWAVE</span></h1>
                    ...
                    >
                      ...
                      <AnimatePresence>
                        {expandedJob === job.id && (
                          ...
                          >
                            <h4 className="text-lg font-semibold text-gray-800 mb-2">Additional Information</h4>
                            <p className="text-gray-700 mb-4">
                              This position is open to candidates from the following branches:
                            </p>
                            ...
                            <p className="text-gray-700">
                              For more details, please visit the <a href={job.jdLink} target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">full job description</a>.
                            </p>
                          </motion.div>
                        )}
                      </AnimatePresence>
